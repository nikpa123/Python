...
executor.start_polling(dp, skip_updates=True, on_startup=on_start) # начало прослушивания (получение сообщений). skip_updates=True когда бот выключен сообщения игнорируются, skip_updates=False копятся